...
#create a db, these are credentials for the database i created
app.config['MYSQL_HOST'] = 'localhost'
app.config['MYSQL_USER'] = 'root'
app.config['MYSQL_PASSWORD'] = 'YOUR OWN PASSWORD '
   ...
   if request.method == 'POST':
       ...
       if form_type == 'addCsvFile':
           ...
           if file:
               ...
               # Rename CSV columns to match your MySQL table's column names
               df.rename(columns={
                   'Region': 'region',
                   'Country': 'country',
                   'Item Type': 'itemType',
               ...
               # Insert data into staging table "csvinfo"
               # (Ensure csvinfo has an "imported" column that defaults to 0.)
